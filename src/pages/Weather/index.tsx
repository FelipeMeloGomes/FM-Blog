    ...
    <LayoutPage height="auto">
      ...
      <div className={styles.container}>
        ...
        {showDetails && !isLoading && (
          <>
            <div className={styles.weather_location}>{climaData.location}</div>
            ...
            <div className={styles.data_container}>
              <div className={styles.element}>
                <Icon name="Humidity" className={styles.icon_font} />
              ...
              <div className={styles.element}>
                <Icon name="Windy" className={styles.icon_font} />
                <div className={styles.data}>
                  <div className={styles.wind_rate}>{climaData.wind} km/h</div>
                  <div className={styles.text}>Velocidade do vento</div>
                </div>
              </div>
            </div>
          </>
